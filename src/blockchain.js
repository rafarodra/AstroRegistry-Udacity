...
class Blockchain {
    ...
    requestMessageOwnershipVerification(address) {
        return new Promise((resolve) => {
            const newTime = new Date().getTime().toString().slice(0,-3);
            resolve(address.toString() + ":" + newTime.toString() + ":starRegistry");
        });
    }
    ...
    submitStar(address, message, signature, star) {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            if(timeDifference > fiveMinutes){
                ...
                this._addBlock(new BlockClass.Block({owner: address, star:star})).then((result) => {
                    resolve(result);
    ...
    getStarsByWalletAddress (address) {
        ...
        return new Promise((resolve, reject) => {
            ...
            stars = self.chain.filter(function(block){
        ...
        return new Promise(async (resolve, reject) => {
            self.chain.forEach(block => {
                ...
                block.validate().then((valid) => {
                    ...
                    else if(block.previousBlockHash !== prevBlockHash){
                        errorLog.push(valid);
                    }
